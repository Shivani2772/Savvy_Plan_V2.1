...
export default class PensionIncomeStartAges extends Component {
  ...
  miniRenderRangeBars = pensionStartAgeMiniRangeBarArray => {
    return pensionStartAgeMiniRangeBarArray.map(propsObject => (
      <MiniRangeBar
        id={propsObject.name}
  ...
  render() {
    const pensionStartAgeMiniRangeBarArray = Object.values(
      this.props.lifetimeIncomeVariableState.pensionAges
    );
